...
<div class="circle1" style="background-color: #eee; height: 400px; width: 400px; position: absolute; border-radius: 350px; display: flex; align-items: center; translate:calc(-50%, 50%); justify-content: center;"></div>
<br><br><br>
